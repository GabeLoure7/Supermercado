...
public class DaoSupermercado {
    ...
    public static List<Supermercado> consultar() {
        ...
        String sql = "SELECT codigo, nome_fantasia, razao_social, fundacao, nr_funcionarios, valor_na_bolsa FROM supermercado";
     ...
     public static Supermercado consultar(int primaryKey) {
        //editar o SQL conforme a entidade
        String sql = "SELECT codigo, nome_fantasia, razao_social, fundacao, nr_funcionarios, valor_na_bolsa FROM supermercado WHERE codigo=?";
        PreparedStatement ps;
        try {
            ps = conexao.Conexao.getConexao().prepareStatement(sql);
